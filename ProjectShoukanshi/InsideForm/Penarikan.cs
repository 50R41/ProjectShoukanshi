...
namespace ProjectShoukanshi.InsideForm
{
    public partial class Penarikan : Form
    {
        ...
        private void panelPnkTitle_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            string Query = "insert into tabungan(id_siswa, nama, tanggal, penarikan) values ('" + textID.Text + "' ,'" + textNama.Text + "' , '" + dateTanggal.Value.Date.ToString("yyyyMMdd") + "' , '" + textPenarikan.Text + "')";
